<%@ Page Title="" Language="C#" MasterPageFile="~/Moderator/Admin.Master" AutoEventWireup="true" CodeBehind="AddNewLocation.aspx.cs" Inherits="MersadWebApplication.Moderator.User.AddNewLocation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#map").css({ "width": 100%, "height": heigh + 40 });
            //var widforf = wid / 2.5;
            $("#f").css({ "height": heigh });
