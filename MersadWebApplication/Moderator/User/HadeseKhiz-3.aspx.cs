...
#pragma warning restore CS0219 // The variable 'noghte' is assigned but its value is never used
        ...
        [WebMethod]
        public static string GetMessage(string txtinsertelamenoghtesooyePolice, string txtinsertinDatabase, string txtinsertdatebazdid, string txtinsertDategharargiridarsaf, string txtinserttarikheshorooeejrayeeghdambarayeNoghte, string txtinserttarikhekhatemeyaftanejrayeeghdam,string ddlListStatus, string txtTozihat, string id)
        {
            string dateElameNoghteAzSooyePolice = "";
            int dateElameNoghteAzSooyePoliceInt = 0;
            string dateSabteNoghteDarSamane = "";
            int dateSabteNoghteDarSamaneInt = 0;
            string datebazdid = "";
            int datebazdidInt = 0;
            string dateGhararGirieNoghteDarsafeEghdam = "";
            int dateGhararGirieNoghteDarsafeEghdamInt = 0;
            string dateShorooeejrayeEghdambarayeNoghte = "";
            int dateShorooeejrayeEghdambarayeNoghteint = 0;
            string dateKhatemeyaftanejrayeEghdam = "";
            int dateKhatemeyaftanejrayeEghdamint = 0;
            string status;
            string tozihat;
            string idnew;

            if (txtinsertelamenoghtesooyePolice != "")
            {
                dateElameNoghteAzSooyePoliceInt = getDateInt(txtinsertelamenoghtesooyePolice);
                dateElameNoghteAzSooyePolice = txtinsertelamenoghtesooyePolice;
            }
            else
            {
                dateElameNoghteAzSooyePoliceInt = 0;
                dateElameNoghteAzSooyePolice = "";
            }
            if (txtinsertinDatabase != "")
            {
                dateSabteNoghteDarSamaneInt = getDateInt(txtinsertinDatabase);
                dateSabteNoghteDarSamane = txtinsertinDatabase;
            }
            else
            {
                dateSabteNoghteDarSamaneInt = 0;
                dateSabteNoghteDarSamane = "";
            }
            if (txtinsertdatebazdid != "")
            {
                datebazdid = txtinsertdatebazdid;
                datebazdidInt = getDateInt(txtinsertdatebazdid);
            ...
            if (txtinsertDategharargiridarsaf != "")
            {
                dateGhararGirieNoghteDarsafeEghdam = txtinsertDategharargiridarsaf;
                dateGhararGirieNoghteDarsafeEghdamInt = getDateInt(txtinsertDategharargiridarsaf);
            }
            else
            {
                dateGhararGirieNoghteDarsafeEghdam = "";
                dateGhararGirieNoghteDarsafeEghdamInt = 0;
            }
            if (txtinserttarikheshorooeejrayeeghdambarayeNoghte != "")
            {
                dateShorooeejrayeEghdambarayeNoghte = txtinserttarikheshorooeejrayeeghdambarayeNoghte;
                dateShorooeejrayeEghdambarayeNoghteint = getDateInt(txtinserttarikheshorooeejrayeeghdambarayeNoghte);
            }
            else
            {
                dateShorooeejrayeEghdambarayeNoghte = "";
                dateShorooeejrayeEghdambarayeNoghteint = 0;
            }
            if (txtinserttarikhekhatemeyaftanejrayeeghdam != "")
            {
                dateKhatemeyaftanejrayeEghdam = txtinserttarikhekhatemeyaftanejrayeeghdam;
                dateKhatemeyaftanejrayeEghdamint = getDateInt(txtinserttarikhekhatemeyaftanejrayeeghdam);
            }
            else
            {
                dateKhatemeyaftanejrayeEghdam = "";
                dateKhatemeyaftanejrayeEghdamint = 0;
            }
            if (id != "")
            {
                idnew = id;
            ...
            {
                context.updateDataDate(dateElameNoghteAzSooyePolice,
                                    dateElameNoghteAzSooyePoliceInt,
                                    dateSabteNoghteDarSamane,
                                    dateSabteNoghteDarSamaneInt,
                                    datebazdid,
                                    datebazdidInt,
                                    dateGhararGirieNoghteDarsafeEghdam,
                                    dateGhararGirieNoghteDarsafeEghdamInt,
                                    dateShorooeejrayeEghdambarayeNoghte,
                                    dateShorooeejrayeEghdambarayeNoghteint,
                                    dateKhatemeyaftanejrayeEghdam,
                                    dateKhatemeyaftanejrayeEghdamint,
                                    status,
                                    tozihat,
                                    idnew);
            }
...
#pragma warning restore CS0472 // The result of the expression is always 'true' since a value of type 'int' is never equal to 'null' of type 'int?'
        ...
        protected void btnRef_Click(object sender, EventArgs e)
        {
            ...
            using (DataManagementDataContext context = new DataManagementDataContext())
            {
                ...
                var getDet = (from m in context.GetDetailByLat(id)
                              select m).FirstOrDefault();
                if (getDet != null)
                {
                    if (getDet.dateElameNoghteAzSooyePolice!=null)
                    {
                        txtinsertelamenoghtesooyePolice.Text = getDet.dateElameNoghteAzSooyePolice.ToString(); 
                    }
                    else
                    {
                        txtinsertelamenoghtesooyePolice.Text = "";
                    }
                    if (getDet.datebazdid!=null)
                    {
                        txtinsertdatebazdid.Text = getDet.datebazdid.ToString(); 
                    }
                    else
                    {
                        txtinsertdatebazdid.Text = "";
                    }
                    if (getDet.dateSabteNoghteDarSamane != null)
                    {
                        txtinsertinDatabase.Text = getDet.dateSabteNoghteDarSamane.ToString(); 
                    }
                    else
                    {
                        txtinsertinDatabase.Text = "";
                    }
                    if (getDet.dateGhararGirieNoghteDarsafeEghdam!=null)
                    {
                        txtinsertDategharargiridarsaf.Text = getDet.dateGhararGirieNoghteDarsafeEghdam.ToString(); 
                    }
                    else
                    {
                        txtinsertDategharargiridarsaf.Text = "";
                    }
                    if (getDet.dateShorooeejrayeEghdambarayeNoghte!=null)
                    {
                        txtinserttarikheshorooeejrayeeghdambarayeNoghte.Text = getDet.dateShorooeejrayeEghdambarayeNoghte.ToString(); 
                    }
                    else
                    {
                        txtinserttarikheshorooeejrayeeghdambarayeNoghte.Text = "";
                    }
                    if (getDet.dateKhatemeyaftanejrayeEghdam!=null)
                    {
                        txtinserttarikhekhatemeyaftanejrayeeghdam.Text = getDet.dateKhatemeyaftanejrayeEghdam.ToString(); 
                    }
                    else
                    {
                        txtinserttarikhekhatemeyaftanejrayeeghdam.Text = "";
                    }
                    if (getDet.tozihat != null)
                    {
                        txtTozihat.Text = getDet.tozihat.ToString();
                    }
                    else
                    {
                        txtTozihat.Text = "";
                    }
                    int ids = int.Parse(getDet.status.ToString());
                    var dssGetStatus = (from m in context.getStatusbyID(ids)
                                        select  m).FirstOrDefault();
                    if (dssGetStatus.statusText!=null)
                    {
                        ddlListStatus.Items.Clear();
                        ddlListStatus.Items.Add(dssGetStatus.statusText);
                    }
                }
        ...
        protected void UpdateLocation_Click(object sender, EventArgs e)
        {
            ...
            // Inject JavaScript to log a message to the browser console
            Console.WriteLine("ID: ppppppppppppppppppppppppppppppppppppppppppppppppppppp");
        }
