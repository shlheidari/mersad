<%@ Page Title="" Language="C#" MasterPageFile="~/Moderator/Admin.Master" AutoEventWireup="true" CodeBehind="TimeComparison.aspx.cs" Inherits="MersadWebApplication.Moderator.Report.TimeComparison" %>
    ...
    <div class="body-wrapper">
        <script>
            $(document).ready(function () {
                ...
                $("#g2p3_0").css({ "height": newHei + 50 });


            });
        </script>
        <div id="divNormalFilter" class="admin-right-panel">
            <asp:HiddenField ID="SelectedID" runat="server" ClientIDMode="Static" />
            ...
            <div id="divNormalFilterX" style="display: block; overflow-y: auto; direction: ltr;">
                <div style="direction: rtl;">
                    <div class="form-group">
                        <div class="white-box">
                            <div style="padding-right: 5px">مقایسه زمانی</div>
                            <hr />
                            <div class="form-group">
                                <div class="cmb-type-chart-time-comp" id="cmbChartTimeComp"><span id="spnChartTimeCompTitle">نوع نمودار</span><i class="fas fa-angle-down yellow" style="float: left"></i></div>
                                <div class="div-type-chart-time-comp" id="divChartTimeComp">
                                    <hr />
                                    <div class="row">
                                        <div class="col-5" style="border-left: 1px solid #787878;">
                                            ...
                                            <div class="first-pad-right-radio">
                                                ...
                                                <label for="rdoAccidentStatistics">شمار تصادفات</label>
                                                <hr />
                                                ...
                                                <hr />
                                                <input type="radio" name="rdoAccident" id="rdoAccidentDeath" value="AccidentDeath" />
                                                <label for="rdoAccidentDeath">سهم تصادفات فوتی</label>
                                            </div>
                                            <hr />
                                            <div><i class="fa fa-road"></i><span>محل تصادف : </span></div>
                                            <div class="first-pad-right-radio">
                                                <input type="radio" name="rdoAccident" id="rdoTypeRoad" />
                                                <label for="rdoTypeRoad">نوع راه</label>
                                            </div>
                                            <hr />
                                            <div><i class="fa fa-history"></i><span>زمان تصادف : </span></div>
                                            <div class="first-pad-right-radio">
                                                <input type="radio" name="rdoAccident" id="rdoAccidentTime" />
                                                <label for="rdoAccidentTime">تصادفات در شب</label>
                                            </div>
                                            <hr />
                                            <div><i class="fa fa-tasks"></i><span>مشخصات تصادف : </span></div>
                                            <div class="first-pad-right-child-radio">
                                                <input type="radio" name="rdoAccident" id="rdoTypeOfCollision" />
                                                <label for="rdoTypeOfCollision">نحوه و نوع برخورد</label>
                                                <hr />
                                                <div class="first-pad-right-radio">
                                                    <input type="radio" name="rdoAccident" id="rdoSingleVehicle" />
                                                    <label for="rdoSingleVehicle">تک وسیله ای</label>
                                                    <hr />
                                                    <input type="radio" name="rdoAccident" id="rdoTwoVehicle" />
                                                    <label for="rdoTwoVehicle">دو وسیله ای</label>
                                                </div>
                                                <hr />
                                                <input type="radio" name="rdoAccident" id="rdoCompleteCause" />
                                                <label for="rdoCompleteCause">علت تامه</label>
                                                <hr />
                                                <input type="radio" name="rdoAccident" id="rdoTypeAccidentCausingOffense" />
                                        ...
                                        <div class="col-7" style="padding-right: 5px">
                                            ...
                                            <div class="first-pad-right-radio">
                                                <input type="radio" name="rdoAccident" id="rdoFuelMaterials" value="FuelMaterials" />
                                                <label for="rdoFuelMaterials">حامل مواد سوختی و خطرناک</label>
                                                <%--  <hr />--%>
                                                <%-- <input type="radio" name="rdoAccident" id="rdoTechnicalProblem" value="TechnicalProblem" />
                                                <label for="rdoTechnicalProblem">دارای نقص فنی و فاقد معاینه فنی</label>--%>
                                                <hr />
                                            ...
                                            <div class="first-pad-right-radio">
                                                <input type="radio" name="rdoAccident" id="rdoCulprit" />
                                                <label for="rdoCulprit">مقصر بومی / غیر بومی</label>
                                                <hr />
                                                <span>گروه سنی : </span>
                                                <div class="first-pad-right-child-radio">
                                                    <input type="radio" name="rdoAccident" id="rdoAgePedestrian" value="Pedestrian60" />
                                                    <label for="rdoAgePedestrian">سن عابران (بیش از 60 سال)</label>
                                                    <hr />
                                                    <input type="radio" name="rdoAccident" id="rdoAgeMotorcycleDriver" value="Motor18" />
                                                    <label for="rdoAgeMotorcycleDriver">سن راکب موتورسیکلت(کمتر از 18 سال)</label>
                                                </div>
                                                <hr />
                                                ...
                                                <label for="rdoSafetyBelt">فاقد کمربند ایمنی</label>
                                                <hr />
                                                <input type="radio" name="rdoAccident" id="rdoHelmet" value="Helmet" />
                                                <label for="rdoHelmet">فاقد کلاه ایمنی</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div style="padding-right: 5px">نمایش داده</div>
                                <hr />
                                <div id="divTypeOfRoad" class="hide">
                                    <input type="radio" name="rdoRoadway" id="rdoMainRoad" value="MainWay" />
                                    <label for="rdoMainRoad">راه اصلی</label>
                                    <br />
                                    ...
                                    <br />
                                    <input type="radio" name="rdoRoadway" id="rdoRoadwayWidthAll" value="SubsidiaryVillage" />
                                    <label for="rdoRoadwayWidthAll">همه</label>
                                </div>
                                <div id="divLightingStatus" class="hide">
                                    ...
                                    <br />
                                    <input type="radio" name="rdoLightingStatus" id="rdoStatusLightAll" value="StatusLightAll" />
                                    <label for="rdoStatusLightAll">همه</label>
                                </div>
                                <div id="divCollision" class="hide">
                                    ...
                                    <label for="rdoCollisionMultiAccident">چند وسیله ای</label>
                                    <br />
                                    ...
                                    <br />
                                    <input type="radio" name="rdoCollision" id="rdoAllVehicle" value="AllVehicle" />
                                    <label for="rdoAllVehicle">همه</label>
                                </div>
                                <div id="divCollisionSingleVehicle" class="hide">
                                    ...
                                    <label for="rdoCrashWithFixedObject">تصادف با شی ثابت</label>
                                    <br />
                                    <input type="radio" name="rdoCollSingleVehicle" id="rdoCrashWithAll" value="CrashWithAll" />
                                    <label for="rdoCrashWithAll">همه</label>
                                </div>
                                <div id="divCollisionTwoVehicle" class="hide">
                                    ...
                                    <br />
                                    <input type="radio" name="rdoCollTwoVehicle" id="rdoTwoVehicleAll" value="AllCollision" />
                                    <label for="rdoTwoVehicleAll">همه</label>
                                </div>
                                <div id="divFinalReason" class="hide">
                                    <input type="radio" name="rdoFinalReason" id="rdoFatigueDrowsiness" value="FatigueDrowsiness" />
                                    <label for="rdoFatigueDrowsiness">خستگی و خواب آلودگی</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoExceedingSpeed" value="ExceedingSpeed" />
                                    <label for="rdoExceedingSpeed">تجاوز از سرعت مقرره</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoLackAttentionFront" value="LackAttentionFront" />
                                    <label for="rdoLackAttentionFront">عدم توجه به جلو</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoFailureObserveDistance" value="FailureObserveDistance" />
                                    <label for="rdoFailureObserveDistance">عدم رعایت فاصله طولی</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoNonObservancePriority" value="NonObservancePriority" />
                                    <label for="rdoNonObservancePriority">عدم رعایت حق تقدم</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoDeviationLeft" value="DeviationLeft" />
                                    <label for="rdoDeviationLeft">انحراف به چپ</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoCrossingPlaceProhibited" value="CrossingPlaceProhibited" />
                                    <label for="rdoCrossingPlaceProhibited">عبور از محل ممنوع</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoMoveOppositeDirection" value="MoveOppositeDirection" />
                                    <label for="rdoMoveOppositeDirection">حرکت در خلاف جهت</label>
                                    <br />
                                    <%--      <input type="radio" name="rdoFinalReason" id="rdoTechnicalDefectsVehicle" value="TechnicalDefectsVehicle" />
                                    <label for="rdoTechnicalDefectsVehicle">نقص فنی مستمر وسیله نقلیه</label>--%>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoSuddenDiversion" value="SuddenDiversion" />
                                    <label for="rdoSuddenDiversion">تغییر مسیر ناگهانی</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoViolationArticle4" value="ViolationArticle4" />
                                    <label for="rdoViolationArticle4">نقض ماده 4 قانون ایمنی راه</label>
                                    <br />
                                    <input type="radio" name="rdoFinalReason" id="rdoAllFinalReason" value="AllFinalReason" />
                                    <label for="rdoAllFinalReason">همه</label>
                                </div>
                                <div id="divCodeCausingAccident" class="hide" style="line-height: 1.8">
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoExceedingSpeedsOver50" value="ExceedingSpeedsOver50" />
                                    <label for="rdoExceedingSpeedsOver50">تجاوز از سرعت بیش از 50 کیلومتر در ساعت</label>
                                    <br />
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoDrivingWhileDrunk" value="DrivingWhileDrunk" />
                                    <label for="rdoDrivingWhileDrunk">
                                        <br />
                                        رانندگی در حالت مستی و مصرف داروهای<br />
                                        روان گردان و افیونی‌</label>
                                    <br />
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoExceedingSpeedsOver30" value="ExceedingSpeedsOver30" />
                                    <label for="rdoExceedingSpeedsOver30">
                                        <br />
                                        تجاوز از سرعت بیش از 30 تا 50 کیلومتر
                                        <br />
                                        در ساعت</label>
                                    <br />
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoIllegalOvertaking" value="IllegalOvertaking" />
                                    <label for="rdoIllegalOvertaking">سبقت غیرمجاز در راه های دو طرفه</label>
                                    <br />
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoCrossRedLight" value="CrossRedLight" />
                                    <label for="rdoCrossRedLight">عبور از چراغ قرمز راهنمایی</label>
                                    <br />
                                    <input type="radio" name="rdoCodeCausingAccident" id="rdoAllCodeCausing" value="AllCodeCausing" />
                                    <label for="rdoAllCodeCausing">همه</label>
                                </div>
                                <div id="divNativeNonNative" class="hide">
                                    ...
                                    <br />
                                    <input type="radio" name="rdoIsLocal" id="rdoAllLicensePlate" value="AllLicensePlate" />
                                    <label for="rdoAllLicensePlate">همه</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="white-box">
                            <div style="padding-right: 5px">زمان های خاص</div>
                            <hr />
                            <div class="row">
                                <div class="col-6">
                                    <div class="form-group">
                                        <select class="w-100" id="cmbSelectMonth">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <select class="w-100" id="cmbSeason">
                                            <option selected="" value="-1">فصل</option>
                                            <option value="01">بهار</option>
                                            <option value="02">تابستان</option>
                                            <option value="03">پاییز</option>
                                            <option value="04">زمستان</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        <div id="divPerfesionalFilter" class="admin-right-panel" style="height: 600px; display: none">
            <div class="panel-head">
        ...
        <div class="d-table-cell chart-panel align-items-top h-100" id="contains">
            ...
            <div id="contains1" class="gray-box form-group">
                <div>
                    <span class="title-chart" id="spnChartTitle">روند ماهانه / سالانه</span>&nbsp;<span class="mersad-info-btn">
                        <%--<i class="fa fa-info-circle"></i>--%>
                    </span>
                </div>
                <div id="contains1_1" class="chart-container" style="overflow: auto">
                    <div id="crtTimeComparison" class="h-100"></div>
                </div>
            </div>
        </div>
        ...
        <script src="/Scripts/jsTimeComparisonHelper.js?n=140104234"></script>
