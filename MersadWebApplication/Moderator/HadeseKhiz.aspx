<%@ Page Title="" Language="C#" MasterPageFile="~/Moderator/Admin.Master" AutoEventWireup="true" CodeBehind="HadeseKhiz.aspx.cs" Inherits="MersadWebApplication.Moderator.HadeseKhiz" %>
        ...
        <script>
            ...
            function GetSlidShow() {
                ...
                if (noe != "0" && getSelectBazeZamani != "0") {
                    ...
                    alert(" موارد بازه زمانی و نوع نقطه حادثه خیز ،انتخاب نشده اند ");
                }
            ...
            <div class="white-box">
                ...
                <div id="divShowDate" style="display: none">
                    <div class="inner-addon left-addon">
                        ...
                        <input type="text" class="rangeFrom" placeholder="انتخاب رنج از تاریخ" id="txtFromDate" maxlength="10" readonly="" />
                        <input type="text" placeholder="انتخاب رنج تاریخ" id="txtToDate" class="rangeTo" maxlength="10" readonly="" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="white-box">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-6">
                        ...
                        <label for="rdbazdid">بازید شده</label>
