...
namespace MersadWebApplication.Moderator.Map
{
    public partial class HeatMap : System.Web.UI.Page
    {
        ...
        //[WebMethod]
        //public static List<ClassInsert> releaseShode()
        //{
            
        //    string lat = HttpContext.Current.Session["res"].ToString();
        //    List<ClassInsert> classInserts= new List<ClassInsert>();
        //    ClassInsert ci = new ClassInsert()
        //    {
        //        Ids = lat
        //    };
        ...
        [WebMethod]
        public static List<GetHeatMap> GetSearchHeatMap(
            ...
            string provinceId, 
            string cityId,
            string inNativeArea, string axisId, string collisionChild1, string collisionChild2, string isLocalDriver)
        {
