<%@ Page Title="" Language="C#" MasterPageFile="~/Moderator/Admin.Master" AutoEventWireup="true" CodeBehind="Newmap.aspx.cs" Inherits="MersadWebApplication.Moderator.Map.Newmap" %>
            ...
            <div class="form-group">
                <div class="white-box">
                    ...
                    <div class="form-group" id="divAxis" style="display: none">
                        <select id="cmbAxis" runat="server" clientidmode="Static">
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div id="mainContainer" class="map-left-panel">
                ...
                <div class="dashboard-left" style="height: 600px">
                    ...
                    <div style="margin-bottom: 70px;">
                        <button type="button" id="divShowHeatMapDetails" disabled=""><i class="fa fa-caret-left" style="vertical-align: super; font-size: 12px;"></i>&nbsp;<i class="fa fa-table-list fa-2x"></i></button>
                    </div>
                    <br />
                    <div class="map-zoom">
                    ...
                    <div id="divAccidentHeatRange">
                        <div class="row">
                            <div class="col-12 text-center"><p class="badge bg-danger">تراکم زیاد</p></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-12 text-center mt-3"><p class="badge bg-success">تراکم کم</p></div>
                        </div>
                    </div>
