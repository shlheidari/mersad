<%@ Page Language="C#" AutoEventWireup="true" Title="نقشه حرارتی" MasterPageFile="~/Moderator/Admin.Master" CodeBehind="HeatMap.aspx.cs" Inherits="MersadWebApplication.Moderator.Map.HeatMap" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="body-wrapper">
        <div id="divNormalFilter" class="admin-right-panel" style="height: 600px">
        ...
        <div class="admin-right-panel" id="divTools" style="display: none">
            <div class="panel-head">ابزارها</div>
            <hr />
            <div class="form-group">
                <div class="white-box">
                    <div style="padding-right: 5px">انتخاب محدوده</div>
                    <hr />
                    <div class="form-group">
                        <div class="col-auto">
                            <span class="input-group">
                                <label class="input-group-text" for="type">انتخاب عارضه:</label>
                                <select class="form-select" id="type" style="width: 50px;">
                                    <option value="None">هیچ</option>
                                    <option value="Box">مستطیل</option>
                                    <option value="Polygon">چندضلعی</option>
                                    <option value="Circle">دایره</option>
                                </select>
                                <input class="form-control" type="button" value="do" id="undo" style="width: 0px; height: 0px; visibility: hidden;">
                            </span>
                        </div>
                        <div class="row" style="visibility: hidden">
                            <div class="col-4">
                                <button type="button" class="tools-icon-border" title="مستطیل" id="divCreateRectangle"><i class="fa fa-border-style-alt fa-3x"></i></button>
                            </div>
                            <div class="col-4">
                                <button type="button" class="tools-icon-border" title="دایره" id="divCreateCircle"><i class="fa fa-circle-o fa-3x"></i></button>
                            </div>
                            <div class="col-4">
                                <button type="button" class="tools-icon-border" title="پالیگان" id="divCreatePolygon"><i class="fa fa-draw-polygon fa-3x"></i></button>
                            </div>
                        </div>
                    </div>
                    <div class="form-group" style="visibility: hidden">
                        <button type="button" id="divRemoveLayerInMap" disabled="">
                            <i class="fa fa-trash-alt fa-2x gray"></i>
                            <span class="gray">حذف انتخاب</span>
                        </button>
                    </div>
                </div>
            </div>
        ...
        <input type="hidden" id="hidAccidentLocation" />
        <div class="d-table-cell align-items-top">
            <div class="align-items-top">
                <div class="filter-parent">
                    ...
                    <div class="tools">
                        <div><i class="fa fa-sliders-h fa-2x"></i></div>
                    </div>
                </div>
            </div>
            ...
            <div id="mainContainer" class="map-left-panel">
                ...
                <div id="divShowGuide">
                    <div class="row head">
                        <div class="col-10 text-start"><i class="fa fa-circle-info fa-2x yellow"></i>&nbsp;<span class="table-head-text yellow">راهنمای جدول داده تصادفات</span></div>
                        <div class="col-2 text-end"><a style="margin-left: -10px; margin-right: 10px"><i onclick="CloseGuide()" class="fa fa-times-circle fa-2x yellow"></i></a></div>
                    </div>
                ...
                <script src="/Scripts/jsHeatMapHelper.js?n=14010526"></script>
                ...
                <div class="dashboard-left" style="height: 600px">
                    ...
                    <div style="margin-bottom: 70px;">
                        <button type="button" id="divShowHeatMapDetails"><i class="fa fa-caret-left" style="vertical-align: super; font-size: 12px;"></i>&nbsp;<i class="fa fa-table-list fa-2x"></i></button>
                    </div>
                    <br />
                    <div class="map-zoom">
                    ...
                    <div id="divAccidentHeatRange">
                        <div class="row">
                            <div class="col-12 text-center">
                                <p class="badge bg-danger">تراکم زیاد</p>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-7 text-center">
                                <div class="left-panel-color-grad"></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12 text-center mt-3">
                                <p class="badge bg-success">تراکم کم</p>
                            </div>
                        </div>
                    </div>
