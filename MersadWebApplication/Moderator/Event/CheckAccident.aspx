<%@ Page Title="" Language="C#" MasterPageFile="~/Moderator/Admin.Master" AutoEventWireup="true" CodeBehind="CheckAccident.aspx.cs" Inherits="MersadWebApplication.Moderator.Event.CheckAccident" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Head">
    ...
    <script src="/Scripts/jsModalHelper.js?n=14000919"></script>
    ...
    <script src="/Scripts/jsCheckAccidentHelper.js?n=14010525"></script>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="body-wrapper">
        <div class="admin-right-panel" style="overflow-y: auto; height: 600px">
            <div class="panel-head">بررسی و تایید رخداد</div>
            <hr />
            ...
            <div class="form-group text-center">
                <div class="confirm-edit-accident hide" id="divUnSuccessComplete">
                    <div>آیا از اتمام بررسی و ثبت نظرات اطمینان دارید؟</div>
                    <br />
                    <button type='button' class='btn btn-outline-success' onclick="SubmitComplete('UnSuccess');">بله</button>
                    <button type='button' class='btn btn-outline-danger' onclick="HideSuccessComplete('UnSuccess')">خیر</button>
                    <div class="spinner-border text-warning" role="status" style="display: none" id="spinUnCompleteLoading">
                        <span class="sr-only">Loading...</span>
                    </div>
                </div>
                <div class="confirm-edit-accident hide" id="divSuccessComplete">
                    <div>آیا از اتمام بررسی و تایید اطلاعات اطمینان دارید؟</div>
                    <br />
                    <button type='button' class='btn btn-outline-success' onclick="SubmitComplete('Success');">بله</button>
                    <button type='button' class='btn btn-outline-danger' onclick="HideSuccessComplete('Success')">خیر</button>
                    <div class="spinner-border text-warning" role="status" style="display: none" id="spinCompleteLoading">
                        <span class="sr-only">Loading...</span>
                    </div>
                </div>
            </div>
            <div class="form-group text-center">
                <button type='button' class='btn btn-warning' id="btnSubmitUnSuccess" onclick="ShowSubmitComplete('UnSuccess');" disabled="">عدم تایید و ثبت نظرات</button>
            </div>
            <div class="form-group text-center">
                <button type='button' class='btn btn-success' id="btnSubmitSuccess" onclick="ShowSubmitComplete('Success');" disabled="">تایید اطلاعات ثبت شده</button>
            </div>
        </div>
        <div class="d-table-cell chart-panel align-items-top padding-all">
            <div id="divFirstStep" style="width: 1120px">
                <div class="row">
                    <div class="col-3">
                        ...
                        <label class="fa-2x">زمان و مکان تصادف</label><span onclick="OpenCommentDialog('First')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                    </div>
                </div>
                <div class="row ">
                    <div class="col-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8 error-parent">
                                    ...
                                    <div class="inner-addon left-addon">
                                        ...
                                        <input type="text" id="txtDateOfAccident" runat="server" clientidmode="Static" onfocus="openDateOfAccident()" aria-label="dateDateOfAccident" aria-describedby="dateDateOfAccident" maxlength="10" readonly="" />
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
            ...
            <div id="divSecondStep" style="width: 1120px;display: none">
                <label class="fa-2x">مشخصات تصادف</label><span onclick="OpenCommentDialog('Second')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row ">
                    <div class="col-2">
                        <div class="white-box-shadow height-250">
                            <div class="form-group row">
            ...
            <div id="divThirdStep" style="width: 1120px;display: none">
                <label class="fa-2x">مشخصات راه و وضعیت جوی</label><span onclick="OpenCommentDialog('Third')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row ">
                    <div class="col-3">
                        <div class="white-box-shadow height-250">
            ...
            <div id="divFourthStep" style="width: 1120px;display: none">
                <label class="fa-2x">علل تصادف</label><span onclick="OpenCommentDialog('Fourth')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row">
                    <div class="col-12">
                        <div class="white-box-shadow">
                            <div class="row">
            ...
            <div id="divFifthStep" style="width: 1120px;display: none">
                <label class="fa-2x">مشخصات افراد و وسایل درگیر در تصادف</label><span onclick="OpenCommentDialog('Fifth')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group row">
                            <div class="col-9">
                    ...
                    <div class="col-3 hide ShowPedestriansInvolved">
                        <div class="white-box-shadow">
                            <div class="form-group row">
                                <label for="txtPedestriansAverageSpeed" class="col-4 col-form-label">سرعت متوسط عابر پیاده</label>
                                <div class="col-8">
                                    <input type="number" id="txtPedestriansAverageSpeed" min="0" max="29" placeholder="متر بر ثانیه" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="txtPedestrianThrowDistance" class="col-4 col-form-label">فاصله پرتاب عابر پیاده</label>
                                <div class="col-8">
                ...
                <div class="row">
                    <div class="col-12 text-center hide" id="divVehiclesButton">
                        <button type='button' id="btnSubmitFifthStep" class="btn-login" onclick="SaveFifthStepData()" data-loading-text="<i class='fa fa-spinner fa-spin '></i> در حال پردازش اطلاعات">مرحله بعد</button>
                        ...
                        <button type='button' id="btnSubmitFifthStepTwo" class="btn-login hide" onclick="SaveFifthStepDataTwo()" data-loading-text="<i class='fa fa-spinner fa-spin '></i> در حال پردازش اطلاعات">مرحله بعد</button>
            ...
            <div id="divSixthStep" style="width: 1120px;display: none">
                <label class="fa-2x">اطلاعات مصدومین و متوفیان</label><span onclick="OpenCommentDialog('Sixth')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row">
                    <div class="col-3">
                        <div class="form-group row">
            ...
            <div id="divSeventhStep" style="width: 1120px;display: none">
                <label class="fa-2x">کروکی تصادف</label><span onclick="OpenCommentDialog('Seventh')"><i class="fa fa-comment-dots fa-3x fa-flip-horizontal gray"></i></span>
                <div class="row">
                    <div class="col-2">
                        <div class="form-group white-box-shadow">
                            <div class="form-group"><i class="fa fa-pen-swirl fa-2x yellow"></i>&nbsp;<span>نصویر کروکی</span></div>
                            <div class="form-group"><span>لطفا تصویر کروکی ترسیم شده را بارگذاری نمایید</span></div>
                        ...
                        <div class="form-group white-box-shadow">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-2">
                                        <i class="fa fa-microphone fa-2x yellow" id="btnOpenMicPrimaryCause"></i>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-2">
                                        <i class="fa fa-microphone fa-2x yellow" id="btnOpenMicDirectCause"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-3">
                        <div class="form-group white-box-shadow">
                            ...
                            <div id="controls">
                                <button type="button" id="recordButton" class="btn btn-outline-success" disabled>ضبط</button>
                                ...
                                <div class="col-8">
                                    <div class="form-group error-parent">
                                        ...
                                        <select id="cmbOrganizationsToBlame">
                                            <option selected="" value="-1">سازمان های مقصر در تصادف</option>
            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    <div id="controlsRecord">
                        <button type="button" id="recordButtonRecord" class="btn btn-outline-success" disabled>ضبط</button>
    ...
    <div class='modal fade' id='CommentModal' tabindex='-1'>
        <div class='modal-dialog'>
            <div class='modal-content'>
                <div class='modal-header'>
                    <h5 class='modal-title' style='padding-right: 20px' id="hTitleComment">ثبت نظر</h5>
                    <button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>&times;</span></button>
                </div>
                <div class='modal-body'>
                    <h4>نکات نیازمند اصلاح را درج نمایید : </h4>
                    <textarea id="txtComment" style="height: 165px"></textarea>
                </div>
                <div class='modal-footer'>
                    <div class="row">
                        <div class="col-12">
                            <button type='button' class='btn btn-outline-warning' onclick="SaveComment()">ثبت</button>
                            <button type='button' class='btn btn-outline-primary' data-dismiss='modal'>بستن این پنجره</button>
                            <input type="hidden" id="hidCommentType" />
